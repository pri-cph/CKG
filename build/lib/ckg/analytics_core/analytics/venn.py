...
def venn5(labels, names=['A', 'B', 'C', 'D', 'E'], **options):
    ...
    draw_text(fig, ax, 0.27, 0.11, labels.get('00001', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.72, 0.11, labels.get('00010', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.55, 0.13, labels.get('00011', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.91, 0.58, labels.get('00100', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.78, 0.64, labels.get('00101', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.84, 0.41, labels.get('00110', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.76, 0.55, labels.get('00111', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.51, 0.90, labels.get('01000', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.39, 0.15, labels.get('01001', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.42, 0.78, labels.get('01010', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.50, 0.15, labels.get('01011', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.67, 0.76, labels.get('01100', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.70, 0.71, labels.get('01101', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.51, 0.74, labels.get('01110', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.64, 0.67, labels.get('01111', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.10, 0.61, labels.get('10000', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.20, 0.31, labels.get('10001', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.76, 0.25, labels.get('10010', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.65, 0.23, labels.get('10011', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.18, 0.50, labels.get('10100', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.21, 0.37, labels.get('10101', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.81, 0.37, labels.get('10110', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.74, 0.40, labels.get('10111', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.27, 0.70, labels.get('11000', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.34, 0.25, labels.get('11001', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.33, 0.72, labels.get('11010', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.51, 0.22, labels.get('11011', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.25, 0.58, labels.get('11100', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.28, 0.39, labels.get('11101', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.36, 0.66, labels.get('11110', '').split(': ')[-1], fontsize=fontsize)
    draw_text(fig, ax, 0.51, 0.47, labels.get('11111', '').split(': ')[-1], fontsize=fontsize)
